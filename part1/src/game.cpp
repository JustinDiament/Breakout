...
void Game::Init()
{
    ...
    // load levels
    GameLevel one; one.Load("levels/one.lvl", this->Width, this->Height / 3);
    GameLevel two; two.Load("levels/two.lvl", this->Width, this->Height / 3);
    GameLevel three; three.Load("levels/three.lvl", this->Width, this->Height / 3);
